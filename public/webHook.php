...
file_put_contents($webPath.'/git_web_hook.log', PHP_EOL.json_encode($content).PHP_EOL, FILE_APPEND);//将每次拉取信息追加写入到日志里
//若是主分支且提交数大于0
if ($content['ref']=='refs/heads/main') {

    //或将命令加入 shell里，s看个人需求 git reset --hard origin/master && git clean -f
